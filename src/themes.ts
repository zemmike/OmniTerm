...
export const THEMES: ThemeDef[] = [
  {
    id: 'matrix', label: 'OmniTerm Matrix', accent: '#00FF41',
    chrome: { background: '#0F0F10', panel: '#161618', border: '#2A2A2E', text: '#E0E0E5', dim: '#88888E' },
    terminal: {
  ...
  {
    id: 'dracula', label: 'Dracula', accent: '#FF79C6',
    chrome: { background: '#191A21', panel: '#21222C', border: '#343746', text: '#F8F8F2', dim: '#8B92B4' },
    terminal: {
  ...
  },
  {
    ...
    chrome: { background: '#242933', panel: '#2E3440', border: '#3B4252', text: '#E5E9F0', dim: '#7B88A1' },
    terminal: {
      ...
      brightGreen: '#B9D5A0', brightYellow: '#F5E0A3', brightBlue: '#9FB8D6', brightMagenta: '#C9A6C4',
      brightCyan: '#9FD6E3', brightWhite: '#ECEFF4',
    },
  },
  {
    id: 'solarized', label: 'Solarized Dark', accent: '#B58900',
    chrome: { background: '#00252e', panel: '#01313d', border: '#0b4a58', text: '#93A1A1', dim: '#718b8b' },
    terminal: {
      ...
      brightGreen: '#719E07', brightYellow: '#CFA715', brightBlue: '#3FA7E0', brightMagenta: '#E06FB0',
      brightCyan: '#44B5AC', brightWhite: '#FDF6E3',
    },
  },
  {
    id: 'gruvbox', label: 'Gruvbox Dark', accent: '#FABD2F',
    chrome: { background: '#1d2021', panel: '#282828', border: '#3c3836', text: '#EBDBB2', dim: '#928374' },
    terminal: {
      background: '#282828', foreground: '#EBDBB2', cursor: '#FABD2F', selectionBackground: '#504945',
      black: '#282828', red: '#FB4934', green: '#B8BB26', yellow: '#FABD2F', blue: '#83A598',
      magenta: '#D3869B', cyan: '#8EC07C', white: '#EBDBB2', brightBlack: '#928374', brightRed: '#FB4934',
      brightGreen: '#B8BB26', brightYellow: '#FABD2F', brightBlue: '#83A598', brightMagenta: '#D3869B',
      brightCyan: '#8EC07C', brightWhite: '#FBF1C7',
    },
  },
  {
    id: 'paper', label: 'Paper (light)', accent: '#0F766E',
    chrome: { background: '#F6F6F4', panel: '#FFFFFF', border: '#DCDCD8', text: '#1F2328', dim: '#6B7280' },
    terminal: {
      background: '#FCFCFA', foreground: '#2B2B2B', cursor: '#0F766E', selectionBackground: '#CDE7E3',
      black: '#2B2B2B', red: '#C0392B', green: '#1A7F37', yellow: '#9A6700', blue: '#0969DA',
      magenta: '#8250DF', cyan: '#0F766E', white: '#6E7781', brightBlack: '#57606A', brightRed: '#D1242F',
      brightGreen: '#1A7F37', brightYellow: '#BF8700', brightBlue: '#218BFF', brightMagenta: '#A475F9',
      brightCyan: '#14B8A6', brightWhite: '#1F2328',
    },
  },
  {
    id: 'custom', label: 'Custom colours', accent: '#00FF41',
    chrome: { background: '#0F0F10', panel: '#161618', border: '#2A2A2E', text: '#E0E0E5', dim: '#88888E' },
    terminal: { background: '#0A0A0B', foreground: '#D7DAE0', cursor: '#22C55E', selectionBackground: '#264F78' },
  },
];
